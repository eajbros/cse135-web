...
print "<br/><br/>";
print "<a href=\"./hw2/perlcode/perl-sessions-2.pl\">Session Page 2</a><br/>";
print "<a href=\"/perl-cgiform.html\">Perl CGI Form</a><br />";
print "<form style=\"margin-top:30px\" action=\"./hw2/perlcode/perl-destroy-session.pl\" method=\"get\">";
